...
const translations = {
    es: {
        ...
        "demo-description": "Esta es una página de demostración con un sistema de temas dinámico y personalizable.",
        "background-description": "El fondo cambia con un gradiente radial que combina el modo de tema (oscuro/claro) con el color seleccionado en el menú de configuración.",
        "container-description": "El contenedor principal tiene un borde semi-transparente que usa el color del selector de temas, creando una experiencia visual cohesiva y moderna.",
        "explore-description": "Explora las diferentes opciones de personalización en el menú lateral para adaptar la interfaz a tu preferencia.",
    ...
    en: {
        ...
        "demo-description": "This is a demo page with a dynamic and customizable theme system.",
        "background-description": "The background changes with a radial gradient that combines the theme mode (dark/light) with the color selected in the settings menu.",
        "container-description": "The main container has a semi-transparent border that uses the color from the theme selector, creating a cohesive and modern visual experience.",
        "explore-description": "Explore the different customization options in the side menu to adapt the interface to your preference.",
...
export default function navbarController() {
    ...
    //     if (isDarkMode) {
    //         // gradient = `radial-gradient(${currentColor}, #333)`;
    //         gradient = `radial-gradient(#111, #111)`;
    //     } else {
    //         gradient = `radial-gradient(#eee, #eee)`;
    //     }
