    ...
    <div className={`${UI_COLORS.container} rounded-xl p-2 md:p-4 space-y-4 print:p-0 print:outline-0`}>
      ...
      <section className="grid sm:grid-cols-2 gap-2">
        <div>
          ...
          <p>
            <span className="capitalize">{`${dataLeng.personal_info.linkedinTitle}: `}</span>
            <Link
              href={dataLeng.personal_info.linkedinUrl}
              className="hover:text-cyan-700 hover:underline"
              target="_blank"
              title={`Link a ${dataLeng.personal_info.linkedinName}`}
              aria-label={`Link to ${dataLeng.personal_info.linkedinName}`}
            >
              <strong className="text-xl">{dataLeng.personal_info.linkedinName}</strong>
            </Link>
          </p>
          ...
          <p>
            ...
            >
              <strong className="text-xl">
                {dataLeng.personal_info.webSiteName}{dataLeng.personal_info.githubName}
              </strong>
            </Link>
          </p>
        </div>
